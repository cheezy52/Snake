(function (root) {
  ...
  Board.prototype.asciiRender = function() {
    var output = "";
  ...
  Board.prototype.addApple = function() {
    var testRow = Math.floor(Math.random() * this.grid.length);
    var testCol = Math.floor(Math.random() * this.grid.length);

    if (this.snake.contains([testRow, testCol])) {
      this.addApple();
    } else {
      this.grid[testRow][testCol] = "a";
    }
  }
